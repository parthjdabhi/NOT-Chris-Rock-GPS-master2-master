...
//  NOT Chris Rock GPS
//
//  Created by iParth on 10/1/16.
//  Copyright © 2016 Harloch. All rights reserved.
//

import UIKit

class VoiceHelpVC1: UIViewController {
...
protocol VoiceHelpVCAudioRecorderViewControllerDelegate: class {
    func audioRecorderViewControllerDismissed(withFileURL fileURL: NSURL?)
}


class VoiceHelpVC: UINavigationController {
    ...
    internal class AudioRecorderChildViewController1: UIViewController {
